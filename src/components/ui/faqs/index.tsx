...
const AccordionItem = ({ title, content }: any) => {
  ...
  return (
    <div className="relative flex flex-col overflow-hidden rounded-sm">
      ...
      />
      <label
        className={`relative title block text-xs lg:text-md font-semibold  px-6 pt-6 lg:px-10 lg:pt-10  cursor-pointer bg-dark text-white rounded-sm ${
...
const Faqs = () => {
  return (
    <div className="container lg:max-w-5xl mb-40 lg:mb-[200px]">
      <h2
        className={
          'text-md lg:text-2h2 text-white text-center max-w-xl mx-auto mb-8 lg:mb-16'
        }
      >
        FAQs–What You Need to Know
      </h2>
      <div className="p-[1px] rounded-sm mb-2"
        style={{background: "linear-gradient(to bottom, rgba(255, 255, 255, 0.15), rgba(255, 255, 255, .6))"}}>
        <AccordionItem
      ...
      <div className="p-[1px] rounded-sm mb-2"
        style={{background: "linear-gradient(to bottom, rgba(255, 255, 255, 0.2), rgba(255, 255, 255, .5))"}}>
        <AccordionItem
